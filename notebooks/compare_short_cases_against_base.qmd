...
```{python}
# | output: false
def change_from_base_case(df: pd.DataFrame, value_col: str, base_case: str = "base-200"):
    group_cols = ["case", "model", "planning_year", "zone", "tech_type", "resource_name", "line_name"]
