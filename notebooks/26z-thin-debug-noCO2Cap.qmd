...
```{python}
#| output: false
folder = "26z-thin-debug-noCO2Cap"
import os
...
chart = (
    ...
    .encode(
        ...
        # column="zone",
        row="planning_year:O",
        tooltip=[alt.Tooltip("tech_type", title="Technology"), alt.Tooltip("end_value", title="Capacity (MW)", format=",.0f")]
    )
...
chart = (
    ...
    .encode(
        ...
        # column="zone",
        row="planning_year:O",
        tooltip=[alt.Tooltip("tech_type", title="Technology"), alt.Tooltip("value", title="Generation (MWh)", format=",.0f")]
    )
    .properties(width=350, height=250)
)
chart
